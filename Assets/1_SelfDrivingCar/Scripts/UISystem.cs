...
public class UISystem : MonoSingleton<UISystem> {
	...
	void Update () {
        ...
        {
            carAI.m_BrakeCondition = CarAIControl.BrakeCondition.NeverBrake;
        }

        if (Input.GetKeyDown(KeyCode.F6))
        {
            carAI.m_BrakeCondition = CarAIControl.BrakeCondition.TargetDirectionDifference;
        }

        if (Input.GetKeyDown(KeyCode.F7))
        {
            carAI.m_BrakeCondition = CarAIControl.BrakeCondition.TargetDistance;
        }
